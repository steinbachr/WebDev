...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Player', fields ['fb_id']
        db.create_unique('pickup_finder_player', ['fb_id'])


        # Changing field 'Game.created'
        db.alter_column('pickup_finder_game', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Game.modified'
        db.alter_column('pickup_finder_game', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):
        # Removing unique constraint on 'Player', fields ['fb_id']
        db.delete_unique('pickup_finder_player', ['fb_id'])


        # Changing field 'Game.created'
        db.alter_column('pickup_finder_game', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Game.modified'
        db.alter_column('pickup_finder_game', 'modified', self.gf('django.db.models.fields.DateTimeField')())
