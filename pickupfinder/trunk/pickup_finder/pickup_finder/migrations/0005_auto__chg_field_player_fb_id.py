...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Player.fb_id'
        db.alter_column('pickup_finder_player', 'fb_id', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Player.fb_id'
        db.alter_column('pickup_finder_player', 'fb_id', self.gf('django.db.models.fields.CharField')(default=None, max_length=50, unique=True))
